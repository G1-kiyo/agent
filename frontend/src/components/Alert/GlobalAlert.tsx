...
const AlertManager = () => {
  ...
  const alertList = useBoundStore((state) => (state as any).alerts)
...
const showAlert = (message, type = 'info', duration = 3000, closable = true) => {
  ...
  getAlertStore().addAlert(newAlert)
  return id
}
...
const removeAlert = (id) => {
  return getAlertStore().removeAlert(id)
}
...
const clearAllAlerts = () => {
  return getAlertStore().clearAllAlerts()
}
 ...
 */
export const wrapAsyncWithAlert = (
